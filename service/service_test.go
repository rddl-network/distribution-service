...
func TestService(t *testing.T) {
	...
	mocks.shamirClientMock.EXPECT().IssueShamirTransaction(uint64(500000000), "liquid1").Times(1).Return(nil)
	mocks.shamirClientMock.EXPECT().IssueShamirTransaction(uint64(500000000), "liquid2").Times(1).Return(nil)
